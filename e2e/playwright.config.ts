...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'mobile-375x812', use: { ...devices['iPhone 12'], viewport: { width: 375, height: 812 } } },
    { name: 'mobile-430x932', use: { ...devices['iPhone 14 Pro Max'], viewport: { width: 430, height: 932 } } },
    { name: 'mobile-landscape-844x390', use: { ...devices['iPhone 12'], viewport: { width: 844, height: 390 }, isMobile: true } },
    { name: 'pwa-standalone-375x812', use: { ...devices['iPhone 12'], viewport: { width: 375, height: 812 } }, metadata: { displayMode: 'standalone' } },
  ],
